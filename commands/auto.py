...
class auto(commands.Cog):
    ...
    async def on_guild_join(self, guild):
        ...
        embed = discord.Embed(
            color=botcolor)
        embed.add_field(name='<:Neko_Logo:549531102117625866>__Server Join__<:Neko_Logo:549531102117625866>',
                        value='** **', inline=False)
        ...
        for a in gc['global']:
            ...
            if channel:
                try:
                    ...
                    embed.set_image(
                        url="https://cdn.discordapp.com/attachments/560579412333166612/616322928367239209/goodbye.jpg")
